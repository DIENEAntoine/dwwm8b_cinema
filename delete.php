...
// Récupérer l'identifiant du film de $_GET en protégeant le srveur contre les failles de type XSS
...
// Effectuer la redirection vers la page d'accueill 
// A rreter l'execution du scrpt
return header("location: index.php");